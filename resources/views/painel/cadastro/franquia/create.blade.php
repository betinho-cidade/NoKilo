...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Nova Franquia</h4>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <h4 class="card-title">Formulário de Cadastro - Franquia</h4>
            ...
            <form name="create_franquia" method="POST" action="{{route('franquia.store')}}"  class="needs-validation"  novalidate>
                @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select id="usuario" name="usuario" class="form-control">
                                    ...
                                    @foreach($usuarios as $usuario)
                                        <option value="{{$usuario->id}}" {{($usuario->id == old('usuario')) ? 'selected' : '' }}>{{$usuario->name}}</option>
                                    @endforeach
                                </select>
                                <div class="valid-feedback">ok!</div>
                                <div class="invalid-feedback">Inválido!</div>
